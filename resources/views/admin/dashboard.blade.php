...
<div class="grid grid-cols-1 md:grid-cols-3 gap-8">
    <!-- Total Armada -->
    <div class="relative group bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100 overflow-hidden transition-all duration-500 hover:shadow-2xl hover:shadow-blue-900/10 hover:-translate-y-2">
        ...
        <div class="relative flex justify-between items-start">
            <div>
                ...
                <h3 class="text-4xl font-black text-[#1a237e] tracking-tighter">{{ \App\Models\Armada::count() }} <span class="text-lg font-bold text-gray-300 ml-1">Unit</span></h3>
            </div>
            <div class="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#1a237e] to-blue-600 flex items-center justify-center text-white shadow-lg shadow-blue-500/30">
    ...
    <!-- Order Aktif -->
    <div class="relative group bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100 overflow-hidden transition-all duration-500 hover:shadow-2xl hover:shadow-yellow-500/10 hover:-translate-y-2">
        ...
        <div class="relative flex justify-between items-start">
            <div>
                ...
                <h3 class="text-4xl font-black text-[#1a237e] tracking-tighter">{{ \App\Models\Booking::where('status', 'on_trip')->count() }} <span class="text-lg font-bold text-gray-300 ml-1">Order</span></h3>
            </div>
            <div class="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#fbc02d] to-[#f9a825] flex items-center justify-center text-[#1a237e] shadow-lg shadow-yellow-500/30">
    ...
    <!-- Total Layanan -->
    <div class="relative group bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100 overflow-hidden transition-all duration-500 hover:shadow-2xl hover:shadow-green-900/10 hover:-translate-y-2">
        ...
        <div class="relative flex justify-between items-start">
            <div>
                ...
                <h3 class="text-4xl font-black text-[#1a237e] tracking-tighter">{{ \App\Models\Layanan::count() }} <span class="text-lg font-bold text-gray-300 ml-1">Jenis</span></h3>
            </div>
            <div class="w-14 h-14 rounded-2xl bg-gradient-to-br from-green-500 to-emerald-600 flex items-center justify-center text-white shadow-lg shadow-green-500/30">
    ...
    <div class="md:col-span-3 bg-white rounded-[2.5rem] shadow-sm p-10 border border-gray-100 min-h-[400px] relative overflow-hidden">
        ...
        <div class="h-64 border-2 border-dashed border-gray-100 rounded-[2rem] flex flex-col items-center justify-center text-gray-400 bg-gray-50/50">
            <div class="w-20 h-20 rounded-full bg-white flex items-center justify-center shadow-sm mb-6">
                <i class="bi bi-clock-history text-3xl opacity-30 text-[#1a237e]"></i>
            </div>
