        ...
        <div class="bg-[#1a237e] rounded-[40px] p-8 text-white shadow-2xl relative overflow-hidden group">
            ...
            <div class="relative z-10">
                ...
                <div class="flex gap-3">
                    ...
                    <a href="{{ route('driver.wallet.withdrawal') }}" class="flex-1 py-4 bg-[#fbc02d] text-[#1a237e] rounded-2xl text-[9px] font-black uppercase tracking-widest text-center shadow-lg transition active:scale-95">Tarik Dana</a>
                </div>
            </div>
        </div>
    </div>
