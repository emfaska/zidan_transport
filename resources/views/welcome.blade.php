...
<body class="antialiased bg-gray-50">
    ...
    <div class="relative bg-white pt-16 overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-8 min-h-[550px] pb-10 lg:pb-16 mt-4 lg:mt-0">
                ...
                <div class="w-full lg:w-1/2 relative lg:h-[550px] flex items-center justify-center animate-fade-in-up delay-300">
                    <div class="relative w-full max-w-[500px] lg:max-w-[85%] mt-8 lg:mt-0">
                        <!-- Swiper Container -->
                        <div class="swiper heroSwiper w-full rounded-[40px] lg:rounded-[60px] overflow-hidden shadow-[0_50px_100px_-20px_rgba(0,0,0,0.4)] border-[8px] lg:border-[12px] border-white/20 backdrop-blur-sm aspect-square md:aspect-[4/3] lg:aspect-[5/4]">
                        ...
                        <!-- Side Accent -->
                        <div class="absolute -top-10 -right-5 lg:-top-16 lg:-right-10 w-40 h-40 bg-[#fbc02d] rounded-full opacity-30 blur-3xl"></div>

                        <!-- Trust Card (Floating) -->
                        <div class="absolute -bottom-6 -right-2 lg:-bottom-10 lg:-right-12 z-40 animate-fade-in-up delay-500">
                            <div class="flex items-center gap-4 p-4 lg:p-5 bg-white/95 backdrop-blur-md rounded-[20px] lg:rounded-[25px] border border-gray-100 shadow-2xl shadow-blue-900/40 max-w-[280px] lg:max-w-[320px] animate-float">
                                <div class="w-12 h-12 lg:w-14 lg:h-14 bg-[#fbc02d] rounded-2xl flex items-center justify-center text-[#1a237e] shadow-lg shrink-0">
